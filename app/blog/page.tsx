...
function Blog() {
  ...
  <div className="mt-10 w-full lg:w-1/4 p-6 gap-6 ml-5">
    ...
    <div className="p-6 rounded-lg">
      <h3 className="text-[24px] text-[#000000] font-[500] mb-4">Categories</h3>
      <ul className="space-y-8 text-[#9F9F9F]">
        {[
          { name: 'Crafts', count: 2 },
          { name: 'Design', count: 8 },
    ...
    {/* Recent Posts */}
    <div className="p-6 rounded-lg ">
      <h3 className="text-[24px] text-[#000000] font-[500] mb-4">Recent Posts</h3>
