  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <Image
        ...
        src="public/singleproduct.svg"
        width={481}
        height={391}
      />
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 className="text-[42px] title-font text-[#000000] tracking-widest">
        Asgaard sofa
        </h2>
        <h1 className="text-[#9F9F9F] text-[24px] title-font font-medium mb-1">
        Rs. 250,000.00
        </h1>
